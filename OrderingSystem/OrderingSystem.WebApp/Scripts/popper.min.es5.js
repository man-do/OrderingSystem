  ...
  'use strict';function e(e) {
    ...
    _function: while (_again) {
      ...
      if (!e || -1 !== ['HTML', 'BODY', '#document'].indexOf(e.nodeName)) return window.document.body;var i = t(e),
          r = i.overflow,
          p = i.overflowX,
          s = i.overflowY;if (/(auto|scroll)/.test(r + s + p)) {
        return e;
      } else {
        _x = o(e);
        _again = true;
    ...
    _function2: while (_again2) {
      ...
      var o = e && e.offsetParent,
          i = o && o.nodeName;if (i && 'BODY' !== i && 'HTML' !== i) {
    ...
    _function4: while (_again4) {
      ...
      if (!e || !e.nodeType || !t || !t.nodeType) return window.document.documentElement;var o = e.compareDocumentPosition(t) & Node.DOCUMENT_POSITION_FOLLOWING,
          i = o ? e : t,
          n = o ? t : e,
          a = document.createRange();a.setStart(i, 0), a.setEnd(n, 0);var f = a.commonAncestorContainer;if (e !== f && t !== f || i.contains(n)) return p(f) ? f : r(f);var l = s(e);if (l.host) {
        _x4 = l.host;
        _x5 = t;
        _again4 = true;
        o = i = n = a = f = l = undefined;
        continue _function4;
      } else {
        _x4 = e;
        _x5 = s(t).host;
    ...
    _function5: while (_again5) {
      var e = _x6;
      _again5 = false;
      var i = e.nodeName;if ('BODY' === i || 'HTML' === i) {
        return !1;
      } else {
